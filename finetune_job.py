"""
============================================================
Agentic World — Fine-Tuning Job (Per-Cluster LoRA, A100 Optimized)
============================================================
Fine-tunes separate LoRA adapters for each behavioral cluster.
Optimized for A100 80GB: full bf16, large batches, packing,
Flash Attention 2, fused AdamW, torch.compile.
...
Usage:
    ...
    python finetune_job.py --all-clusters --epochs 3 --lora-rank 64 --no-wandb
============================================================
"""
...
def train_cluster(cluster_id: int) -> dict:
    ...
    # Load fresh base model for each cluster (full bf16, no quantization)
